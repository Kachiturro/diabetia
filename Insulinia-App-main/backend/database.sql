...
CREATE DATABASE IF NOT EXISTS insulinia_db;
USE insulinia_db;
...
BEGIN
    INSERT INTO UsuarioPrincipal (
        nombre, sexo, fechaNacimiento, domicilio, celular, correo, contrasena
    ) VALUES (
        p_nombre, p_sexo, p_fechaNacimiento, p_domicilio, p_celular, p_correo, p_contrasena
    );
...
INSERT INTO UsuarioPrincipal (nombre, sexo, fechaNacimiento, domicilio, celular, correo, contrasena) VALUES
